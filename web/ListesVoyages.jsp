<%-- 
    Document   : ListesVoyages
    Created on : 4 janv. 2024, 08:38:54
    Author     : hp
--%>
        ...
        <div class="card">
            ...
            <div class="text-nowrap">
                <table class="table">
                    ...
                    <tbody >
                        <%
                            Vector<Voyage> listesVoyage = (Vector<Voyage>) request.getAttribute("listesVoyages");
                        ...
                        <tr>
                            ...
                            <th>
                                <a class="dropdown-item" href="ReservationServelet?idvoyage=<%= voyage.getIdVoyage() %>"> <span class="badge bg-label-info me-1">Reserver</span></a>
                            </th>
                        </tr>
                        <% } %>
                    </tbody>
