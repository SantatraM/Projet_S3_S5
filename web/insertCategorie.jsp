                    ...
                    <div class="card-body">
                        <form action="CategorieServelet" method="post">
                            ...
                            <div class="mb-3" id="form">
                                ...
                                <div class="col-md-10">
                                    <input class="form-control" type="text"  id="html5-date-input" name="categorie1" />
                                </div>
...
<script>
    ...
    function autreCategorie() {
        ...
        var nouveau = '<div class="col-md-10"><input class="form-control" type="text"  id="html5-date-input" name=categorie'+nombreArticle+' /></div><div class="navbar-nav align-items-center"> <div class="nav-item d-flex align-items-center"><span id="plus"><label for="exampleFormControlSelect1" class="form-label"><button type="button" onclick="nombreArticle=autreCategorie()">+</button></label></span> </div></div>';
