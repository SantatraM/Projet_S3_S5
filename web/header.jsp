...
>
  ...
  <body>
    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container" style="min-height: 0vh;">
        <!-- Menu -->
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo">
            <a href="index.html" class="app-brand-link">
              ...
              <span class="app-brand-text demo menu-text fw-bolder ms-2">Voyage</span>
            </a>
          ...
          <ul class="menu-inner py-1">
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                ...
                <div data-i18n="Authentications">Activite</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="insertActivity.jsp" class="menu-link">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <!-- <i class="menu-icon tf-icons bx bx-lock-open-alt"></i> -->
                <div data-i18n="Authentications">Bouquet</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="insertBouquet.jsp" class="menu-link">
            ...
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <!-- <i class="menu-icon tf-icons bx bx-lock-open-alt"></i> -->
                <div data-i18n="Authentications">Categorie de lieu</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="insertCategorie.jsp" class="menu-link">
                    <div data-i18n="Basic">Insertion categorie</div>
                  </a>
                </li>
              </ul>
            </li>
            <li class="menu-item">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <!-- <i class="menu-icon tf-icons bx bx-lock-open-alt"></i> -->
                <div data-i18n="Authentications">Activite d'un Bouquet</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item">
                  <a href="BouquetActivite" class="menu-link">
                    <div data-i18n="Basic">Insertion Activite</div>
                  </a>
                </li>
                <li class="menu-item">
                  <a href="BouquetActiviteServelet" class="menu-link">
                    <div data-i18n="Basic">Listes Activites par Bouquet</div>
                  </a>
                </li>
              </ul>
            </li>
